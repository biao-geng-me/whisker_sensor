...
class V2Paths16HardwareRunner:
    """Minimal inference wrapper for the v2 paths16 path-blind hardware handoff.
...
def main() -> None:
    parser = argparse.ArgumentParser(description='Minimal hardware-side inference wrapper for the v2 paths16 checkpoint.')
    parser.add_argument('--package-dir', type=str, default='.')
    parser.add_argument('--device', type=str, default='cpu')
    args = parser.parse_args()

    runner = V2Paths16HardwareRunner(args.package_dir, device=args.device)
