classdef ExpControlPanel < handle
    ...
    methods
        function obj = ExpControlPanel(parent)
            ...
            obj.Vel1Field = uieditfield(obj.Grid,'numeric','Value',0.16, ...
            ...
            obj.RotationStepField = uieditfield(obj.Grid,'numeric','Value',1.0, ...
                'Limits',[0 Inf], ...
            ...
            obj.EpisodeTimeField = uieditfield(obj.Grid,'numeric','Value',25.0);
            ...
            obj.SettleDelayField = uieditfield(obj.Grid,'numeric','Value',26.0,...
